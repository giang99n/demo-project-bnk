...
class RegisterFamilyMemberScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context)=> RegisterFamilyMemberBloc(RegisterFamilyMemberInitState(), Api()))
      ],
...
class _BuildResidentCardScreenState extends State<BuildResidentCardScreen> {
  ...
  Api? api;
  RegisterFamilyMemberBloc? registerFamilyMemberBloc;

  @override
  void initState() {
    registerFamilyMemberBloc = BlocProvider.of<RegisterFamilyMemberBloc>(context);
  ...
  _buildBody(BuildContext context) {
    ...
    final msg = BlocBuilder<RegisterFamilyMemberBloc, RegisterFamilyMemberState>(
        builder: (context, state) {
          if (state is RegisterFamilyMemberLoadingState) {
            return const CircularProgressIndicator();
          } else if (state is RegisterFamilyMemberErrorState) {
    ...
    return
      Scaffold(
        body: BlocListener<RegisterFamilyMemberBloc, RegisterFamilyMemberState>(
          listener: (context, state) {
            if (state is RegisterFamilyMemberSuccessState) {
                        ...
                        TextContainer(
                          child: TextFormField(
                            onTap: () async {
                              ...
                              moveInDate.text = DateFormat('dd-MM-yyyy').format(date);
                            },
                        ...
                        TextContainer(
                          child: TextFormField(
                            onTap: () async {
                              ...
                              moveOutDate.text = DateFormat('dd-MM-yyyy').format(date);
                            },
                            controller: moveOutDate,
                            cursorColor: kPrimaryColor,
                            onChanged: (value) {},
                            decoration: InputDecoration(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () {
                                if (_formkey.currentState!.validate()) {
                                  print("successful");
                                  return registerFamilyMemberBloc!.add(RegisterFamilyMemberButtonPressed(
                                      name: name.text));
                                } else {
                                  print("UnSuccessfull");
                                }
