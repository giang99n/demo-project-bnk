...
class RegisterVerhicleBloc
    extends Bloc<RegisterVerhicleEvents, RegisterVerhicleState> {
  Api apiRepository;

  RegisterVerhicleBloc(RegisterVerhicleState initialState, this.apiRepository)
      : super(initialState);

  @override
  Stream<RegisterVerhicleState> mapEventToState(
      RegisterVerhicleEvents event) async* {
