...
class RegisterFamilyMemberBloc
    extends Bloc<RegisterFamilyMemberEvents, RegisterFamilyMemberState> {
  Api apiRepository;

  RegisterFamilyMemberBloc(
      RegisterFamilyMemberState initialState, this.apiRepository)
      : super(initialState);

  @override
  Stream<RegisterFamilyMemberState> mapEventToState(
      RegisterFamilyMemberEvents event) async* {
