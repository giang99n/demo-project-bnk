...
class RegisterResidentBloc extends Bloc<RegisterResidentEvents, RegisterResidentState> {
  Api apiRepository;
  RegisterResidentBloc(RegisterResidentState initialState,this.apiRepository ): super(initialState);

  @override
  Stream<RegisterResidentState> mapEventToState(RegisterResidentEvents event) async*{
