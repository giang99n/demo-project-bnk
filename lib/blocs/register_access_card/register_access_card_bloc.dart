...
class RegisterAccessCardBloc
    extends Bloc<RegisterAccessCardEvents, RegisterAccessCardState> {
  Api apiRepository;

  RegisterAccessCardBloc(
      RegisterAccessCardState initialState, this.apiRepository)
      : super(initialState);

  @override
  Stream<RegisterAccessCardState> mapEventToState(
      RegisterAccessCardEvents event) async* {
